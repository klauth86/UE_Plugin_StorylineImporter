...
#include "StorylineEdProj_5_01GameModeBase.generated.h"

UCLASS()
class STORYLINEEDPROJ_5_01_API AStorylineEdProj_5_01GameModeBase : public AGameModeBase
{
	GENERATED_BODY()
...
UCLASS(BlueprintType, Blueprintable)
class STORYLINEEDPROJ_5_01_API UP_Quest_FinishedM : public UP_Base
{
	GENERATED_BODY()
...
UCLASS(BlueprintType, Blueprintable)
class STORYLINEEDPROJ_5_01_API UGE_Item_PickUpM : public UGE_Base
{
	GENERATED_BODY()
