...
class STORYLINEEDPROJ_5_01_API IInteractionSource
{
	GENERATED_BODY()
...
UCLASS()
class STORYLINEEDPROJ_5_01_API AStorylineSource_Basic : public AActor, public IStorylineSource
{
	GENERATED_BODY()
...
struct STORYLINEEDPROJ_5_01_API FQuestAlternativeEntry
{
...
USTRUCT(BlueprintType)
struct STORYLINEEDPROJ_5_01_API FQuestStepEntry
{
	GENERATED_USTRUCT_BODY()
...
class STORYLINEEDPROJ_5_01_API AStorylineContext_Basic : public AActor, public IStorylineContext
{
...
UCLASS()
class STORYLINEEDPROJ_5_01_API AStorylineGameMode_Basic : public AGameModeBase
{
	GENERATED_UCLASS_BODY()
...
UCLASS()
class STORYLINEEDPROJ_5_01_API ADialogCharacter : public ACharacter, public IInteractionSource
{
	GENERATED_UCLASS_BODY()
...
UCLASS()
class STORYLINEEDPROJ_5_01_API AInventoryActor : public AStaticMeshActor
{
	GENERATED_UCLASS_BODY()
...
class STORYLINEEDPROJ_5_01_API UP_Dialog_Node_Has_PrevSessionsM : public UP_Base
{
	GENERATED_BODY()
...
UCLASS(BlueprintType, Blueprintable)
class STORYLINEEDPROJ_5_01_API UP_Item_HasM : public UP_Base
{
	GENERATED_BODY()
...
UCLASS(BlueprintType, Blueprintable)
class STORYLINEEDPROJ_5_01_API UP_Quest_AddedM : public UP_Base
{
	GENERATED_BODY()
...
UCLASS(BlueprintType, Blueprintable)
class STORYLINEEDPROJ_5_01_API UP_Quest_Node_Passed : public UP_Base
{
	GENERATED_BODY()
...
UCLASS(BlueprintType, Blueprintable)
class STORYLINEEDPROJ_5_01_API UGE_Item_DropM : public UGE_Base
{
	GENERATED_BODY()
...
UCLASS(BlueprintType, Blueprintable)
class STORYLINEEDPROJ_5_01_API UGE_Quest_Node_AddM : public UGE_Base
{
	GENERATED_BODY()
...
UCLASS(BlueprintType, Blueprintable)
class STORYLINEEDPROJ_5_01_API UGE_Quest_Node_PassM : public UGE_Base
{
	GENERATED_BODY()
...
UCLASS(BlueprintType, Blueprintable)
class STORYLINEEDPROJ_5_01_API UGE_Quest_AddM : public UGE_Base
{
	GENERATED_BODY()
